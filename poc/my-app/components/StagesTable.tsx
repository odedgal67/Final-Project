...
import { Button, Text, Pressable, StyleSheet, View, SafeAreaView, ScrollView} from "react-native";
...
const StagesTable = (props: {stagesNames: String[], stagesStatuses: String[], columnTitle: String, ButtonHandler: (arg0: String)=>any}) => {
  return (
    <ScrollView>
