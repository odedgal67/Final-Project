...
export var hebrew = {
  ...
  id: "תעודת זהות",
  password: "סיסמה",
  change_name: "שינוי שם",
  new_name: "שם חדש",
  change_password: "שינוי סיסמה",
  new_password: "סיסמה חדשה",
  name_changed_successfully: "השם שונה בהצלחה",
  password_changed_successfully: "הסיסמה שונתה בהצלחה",
  password_instructions: "הסיסמה חייבת להכיל 8 עד 20 תווים שכוללים לפחות אות וספרה",
  apartment: "דירה",
  floor: "קומה",
  apartment_stages: "עבודות גמר בדירה ${apartment}",
  urgency: "דחיפות",
